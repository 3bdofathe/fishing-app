...
import { Check, CreditCard, DateRange, DeleteForeverOutlined, Lock } from "@mui/icons-material";
import "./Payment.css";
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <form onSubmit={() => navigate("/payment5")}>
                ...
                >
                  <Box
                    ...
                    sx={{ width: "100%" }}
                  >
                    <label className="lapelContact">Card Number</label>
                    <TextField
                      id="outlined-basic"
                      type="text"
                      variant="outlined"
                      ...
                      slotProps={{
                        input: {
                          endAdornment: <CreditCard sx={{color: 'rgba(108, 108, 108, 1)'}}></CreditCard>,
                        },
                      }}
                    />
                  </Box>
                ...
                >
                  <Box
                    ...
                    sx={{ width: "47%" }}
                  >
                    <label className="lapelContact">End Date</label>
                    <TextField
                      id="outlined-basic"
                      type="text"
                      variant="outlined"
                      ...
                      slotProps={{
                        input: {
                          endAdornment: <DateRange sx={{color: 'rgba(108, 108, 108, 1)'}}></DateRange>,
                        },
                      }}
                    />
                  </Box>
                  <Box
                    ...
                    sx={{ width: "47%" }}
                  >
                    <label className="lapelContact">CVV</label>
                    <TextField
                      id="outlined-basic"
                      type="text"
                      variant="outlined"
                      ...
                      slotProps={{
                        input: {
                          endAdornment: <Lock sx={{color: 'rgba(108, 108, 108, 1)'}}></Lock>,
                        },
                      }}
                    />
                  </Box>
