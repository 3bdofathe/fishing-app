...
export default function Payment1() {
  ...
  return (
    ...
    >
      ...
      <Box mt={"150px"} sx={{ width: { xs: "90%", sm: "90%", md: "85%" }, mb: 6 }}>
        <Box
          display={"flex"}
          alignItems={"center"}
        ...
        >
          ...
          >
            ...
            >
              <form onSubmit={()=> navigate('/payment2')}>
                <Box
                  sx={{
                    display: "flex",
                    alignItems: "center",
                ...
                >
                  <Box display={"flex"} flexDirection={"column"} sx={{width:"47%"}}>
                    <label className="lapelContact">First Name</label>
                    <TextField
                      id="outlined-basic"
                      type="text"
                      variant="outlined"
                  ...
                  <Box display={"flex"} flexDirection={"column"} sx={{width:"47%"}}>
                    <label className="lapelContact">Last Name</label>
                    <TextField
                      id="outlined-basic"
                      type="text"
                      variant="outlined"
                ...
                >
                  <Box display={"flex"} flexDirection={"column"} sx={{width:"47%"}}>
                    <label className="lapelContact">E-mail</label>
                    <TextField
                      id="outlined-basic"
                      type="email"
                      variant="outlined"
                  ...
                  <Box display={"flex"} flexDirection={"column"} sx={{width:"47%"}}>
                    <label className="lapelContact">Phone Number</label>
                    <TextField
                      id="outlined-basic"
                      type="text"
                      variant="outlined"
